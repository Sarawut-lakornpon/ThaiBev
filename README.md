...
## ฟีเจอร์ที่เพิ่มเติม (Implemented Features)
- [x] ระบบออกคิวแบบ Alpha-numeric (A0 - Z9)
- [x] หน้าจอรับบัตรคิว (Kiosk UI) ปรับขนาดปุ่มให้ใหญ่ขึ้นเพื่อใช้งานง่าย
- [x] แสดงวันที่และเวลาที่ออกคิวในหน้าบัตรคิว
- [x] ระบบล้างคิว (Reset Queue) พร้อมข้อความยืนยันภาษาไทย
- [x] การจัดการฐานข้อมูล SQLite (Thread-safe)
